C***********************************************************
C This is ACM Licensed Code
C https://www.acm.org/publications/policies/\
C software-copyright-notice
C
C Typically compiled like so...
C gfortran -fdefault-real-8 -fdefault-double-8 -shared\
C -fPIC -o libstripack.so stripack.f
C***********************************************************
